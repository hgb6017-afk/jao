...
- (void)refreshWithContactsEnabled:(BOOL)contactsEnabled callHistoryEnabled:(BOOL)callHistoryEnabled defaultRegion:(NSString *)region completion:(dispatch_block_t)completion {
