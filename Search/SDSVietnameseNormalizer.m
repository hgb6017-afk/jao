...
+ (NSString *)identityKeyForNumber:(NSString *)input defaultRegion:(NSString *)region {
...
+ (NSArray<NSString *> *)searchKeysForNumber:(NSString *)input defaultRegion:(NSString *)region {
    NSString *normalized = [SDSPhoneNumberNormalizer normalizedDialableString:input];
